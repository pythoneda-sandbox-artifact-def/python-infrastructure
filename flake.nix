...
{
  description =
    "Nix flake for pythoneda-sandbox-artifact/python-infrastructure";
  inputs = rec {
    ...
    pythoneda-sandbox-artifact-python = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-sandbox-artifact-def/python/0.0.90";
    };
    pythoneda-shared-pythonlang-infrastructure = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.13";
        sha256 = "0nwjd0yf4ami5ymmggz4fg5w3iziyp99x7r31bpgcf8gdf06zqhj";
        pname = "${org}-${repo}";
        ...
        pythoneda-sandbox-artifact-python-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-sandbox-artifact-python} ${pythoneda-shared-artifact-events-infrastructure} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-sandbox-artifact-python-infrastructure-python312;
          ...
          pythoneda-sandbox-artifact-python-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-sandbox-artifact-python-infrastructure-python312;
          ...
          pythoneda-sandbox-artifact-python-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-sandbox-artifact-python-infrastructure-python313;
