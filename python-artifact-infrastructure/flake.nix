# python-artifact-infrastructure/flake.nix
#
# This file packages pythoneda-sandbox/python-artifact-infrastructure as a Nix flake.
#
# Copyright (C) 2023-today rydnr's https://github.com/pythoneda-sandbox/python-artifact-infrastructure-artifact
#
...
{
  description = "Infrastructure layer for pythoneda-sandbox/python-artifact";
  inputs = rec {
    ...
    pythoneda-shared-artifact-changes-events-infrastructure = {
      ...
      # inputs.pythoneda-shared-artifact-changes-events.follows =
      #  "pythoneda-sandbox-python-artifact/pythoneda-shared-artifact-changes-events";
    ...
    INDIRECT-INDIRECT-pythoneda-shared-code-requests-shared = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
      # inputs.pythoneda-shared-nix-flake-shared.inputs.pythoneda-shared-git-shared.follows = "pythoneda-sandbox-python-artifact/pythoneda-shared-git-shared";
      # inputs.pythoneda-shared-nix-flake-shared.inputs.pythoneda-shared-git-shared.follows = "pythoneda-sandbox-python-artifact/pythoneda-shared-git-shared";
      inputs.pythoneda-shared-nix-flake-shared.follows =
        "INDIRECT-INDIRECT-INDIRECT-pythoneda-shared-nix-flake-shared";
      inputs.pythoneda-shared-pythoneda-banner.follows =
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pythoneda-sandbox-python-artifact-infrastructure-for = { python
          , pythoneda-shared-artifact-changes-events-infrastructure
          , pythoneda-shared-pythoneda-domain, pythoneda-sandbox-python-artifact
          , pythoneda-shared-pythoneda-infrastructure }:
          let
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-sandbox-python-artifact-infrastructure-default;
          pythoneda-sandbox-python-artifact-infrastructure-default =
            pythoneda-sandbox-python-artifact-infrastructure-python311;
          pythoneda-sandbox-python-artifact-infrastructure-python38 =
            shared.devShell-for {
              banner = "${
                  pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python38
                }/bin/banner.sh";
              package =
                packages.pythoneda-sandbox-python-artifact-infrastructure-python38;
          ...
          pythoneda-sandbox-python-artifact-infrastructure-python39 =
            shared.devShell-for {
              banner = "${
                  pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python39
                }/bin/banner.sh";
              package =
                packages.pythoneda-sandbox-python-artifact-infrastructure-python39;
          ...
          pythoneda-sandbox-python-artifact-infrastructure-python310 =
            shared.devShell-for {
              banner = "${
                  pythoneda-shared-pythoneda-banner.packages.${system}.pythoneda-shared-pythoneda-banner-python310
                }/bin/banner.sh";
              package =
                packages.pythoneda-sandbox-python-artifact-infrastructure-python310;
          ...
          pythoneda-sandbox-python-artifact-infrastructure-python311 =
            shared.devShell-for {
              ...
              package =
                packages.pythoneda-sandbox-python-artifact-infrastructure-python311;
        ...
        packages = rec {
          ...
          pythoneda-sandbox-python-artifact-infrastructure-default =
            pythoneda-sandbox-python-artifact-infrastructure-python311;
          pythoneda-sandbox-python-artifact-infrastructure-python38 =
            pythoneda-sandbox-python-artifact-infrastructure-for {
              python = pkgs.python38;
              pythoneda-shared-artifact-changes-events-infrastructure =
